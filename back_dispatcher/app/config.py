...
BOOTSTRAP_ADMIN_DISPLAY_NAME = os.getenv("BOOTSTRAP_ADMIN_DISPLAY_NAME", "Администратор КТЖ")
...
DEMO_DISPATCHER_DISPLAY_NAME = os.getenv("DEMO_DISPATCHER_DISPLAY_NAME", "Диспетчер КТЖ")
...
DEMO_TRAIN_DISPLAY_NAME = os.getenv(
    ...
    f"Поезд КТЖ {DEMO_TRAIN_LOCOMOTIVE_ID}",
)
